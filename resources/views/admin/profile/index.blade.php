                            ...
                            <div class="border border-primary pt-3 mt-3 rounded shadow">
                                ...
                                <ul class="list-group list-group-flush p-3">
                                    ...
                                    <li class="list-group-item bg-transparent text-white">
                                        <a href="{{route('admin.index')}}"  class="btn btn-sm wbtn border text-white fw-bold float-end"> Back</a>

                                       <a href="{{route('admin.profile.edit')}}"  class="btn btn-sm wbtn border text-white fw-bold float-end">Edit</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
