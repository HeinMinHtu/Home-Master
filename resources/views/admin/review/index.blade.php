                            ...
                            <div class="row">
                                <div class="col-11">
                                    <div class="d-flex jusitfy-content-center gap-3">
                                        ...
                                        <a href="{{url()->previous()}}" class="page-title text-decoration-none text-white mt-2 p-3 border-bottom border-primary hover-grow-card">
                            ...
                            <tbody class=" border-success">
                                ...
                                @foreach ($reviews as $review)
                                    <tr>
                                        ...
                                        <td >
                                           <a href="{{route('admin.customer.detail',$review->user->id)}}" class="text-decoration-none text-white">{{ $review->user->name }}</a>
                                        </td>
                                        <td >
                                           <a href="{{route('admin.customer.detail',$review->serviceProvider->id)}}" class="text-decoration-none text-white"> {{ $review->serviceProvider->name }}</a>
                                        </td>
