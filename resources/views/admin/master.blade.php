...
.custom-table td, .custom-table th {
    border-bottom: 1px solid #70b0c0; /* Add bottom border to each td and th */
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav wbtn sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Admin <sup class="text-lowercase"></sup></div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
                ...
                <li class="nav-item {{ request()->routeIs('admin.customers.list') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ request()->routeIs('admin.services.list') ? 'active' : '' }}">
                    <a class="nav-link" href="{{route('admin.services.list')}}">
                        <i class="fa-brands fa-imdb"></i>
                        <span>၀န်ဆောင်မှုပေးသူ</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('admin.service.category.list') ? 'active' : '' }}">
                    <a class="nav-link" href="{{route('admin.service.category.list')}}">
                        <i class="fa-brands fa-imdb"></i>
                        <span>ခွင့်ပြုထားသော၀န်ဆောင်မှုများ</span>
                    </a>
                </li>
                ...
                <li class="nav-item {{ request()->routeIs('admin.posts.list') ? 'active' : '' }}">
                    <a class="nav-link" href="{{route('admin.posts.list')}}">
                        <i class="fa-brands fa-imdb"></i>
                        <span>ပိုစ့်များ</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('admin.booking.list') ? 'active' : '' }}">
                    <a class="nav-link" href="{{route('admin.booking.list')}}">
                        <i class="fa-brands fa-imdb"></i>
                        <span>၀န်ဆောင်မှုဘွတ်ကင်</span>
                    </a>
                </li>

                <li class="nav-item {{ request()->routeIs('admin.cust.review.list') ? 'active' : '' }}">
                    <a class="nav-link" href="{{route('admin.reviewAll.list')}}">
                        <i class="fa-brands fa-imdb"></i>
